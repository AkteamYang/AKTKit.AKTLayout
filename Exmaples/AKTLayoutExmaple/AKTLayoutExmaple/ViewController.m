...
- (void)viewDidLoad {
  ...
  @{kClass:@"ExampleMasonry",kImg:@"AKT_Test1",kTitle:@"Masonry Orientation Test"},
  @{kClass:@"ExampleAKTLayout",kImg:@"AKT_Test2",kTitle:@"AKTLayout Orientation Test"},
...
//    CGFloat whRation = self.header.image.size.width/self.header.image.size.height;
//    return mAKT_SCREENWITTH/whRation;
//}
